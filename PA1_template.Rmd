...
In the dataset were found **`r as.character(missingValues)`** values. In order to replace the missing values, it will be used the Mean value for each time interval.
...
| Dataset                | Mean             |Median             |
| -----------------------|----------------- | ----------------- |
| **NA Removed (Prev)**  | *`r sprintf("%.4f", stepsMean)`*  | *`r sprintf("%.4f",stepsMedian)`* |
| **NA Replaced (New)**  | *`r sprintf("%.4f",stepsMean2)`* | *`r sprintf("%.4f",stepsMedian2)`*|
